...
#
# Script generated by Vivado on Sat Nov 15 00:16:09 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_fp_mul_pipelined.sh
...
#
# Usage        : tb_fp_mul_pipelined.sh
#                tb_fp_mul_pipelined.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_fp_mul_pipelined.sh [-reset_run]
#                tb_fp_mul_pipelined.sh [-reset_log]
#                tb_fp_mul_pipelined.sh [-help]
#
...
# script info
echo -e "tb_fp_mul_pipelined.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_fp_mul_pipelined.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_fp_mul_pipelined xil_defaultlib.tb_fp_mul_pipelined xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_fp_mul_pipelined -key {Behavioral:sim_1:Functional:tb_fp_mul_pipelined} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_fp_mul_pipelined.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_fp_mul_pipelined.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_fp_mul_pipelined.sh [-help]\n\
Usage: tb_fp_mul_pipelined.sh [-step]\n\
Usage: tb_fp_mul_pipelined.sh [-lib_map_path]\n\
Usage: tb_fp_mul_pipelined.sh [-reset_run]\n\
Usage: tb_fp_mul_pipelined.sh [-reset_log]\n\
Usage: tb_fp_mul_pipelined.sh [-keep_index]\n\
Usage: tb_fp_mul_pipelined.sh [-noclean_files]\n\n\
